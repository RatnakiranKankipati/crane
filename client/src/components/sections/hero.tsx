          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-center">
               ...
               {/* <div className="text-xs text-muted-foreground">Complete models & drawings</div> */}
                {/* <p className="text-3xl font-bold text-foreground" data-testid="text-time-reduction">2hrs</p> */}
                  <p className="text-sm text-muted-foreground font-medium">Complete models & drawings in </p>
